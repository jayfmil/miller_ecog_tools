...
## SubjectLevel - Creating a subject
...
## SubjectLevel - class structure

When you create a subject as shown above, you are really creating a subclass of the classes `SubjectDataBase` and `SubjectAnalysisBase`. `SubjectDataBase` has methods for loading, computing, and saving data. `SubjectAnalysisBase` has methods for loading, computing, and saving analysis results. `SubjectDataBase`
