...
class SubjectEncRecSim(SubjectAnalysis):
    """
    ...
    def __init__(self, task=None, subject=None, montage=0, use_json=True):
        super(SubjectEncRecSim, self).__init__(task=task, subject=subject, montage=montage, use_json=use_json)
